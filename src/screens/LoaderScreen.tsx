...
<style>
  ...
  .r0   { transform: translate(-50%, -50%) rotate(0deg); }
  .r22  { transform: translate(-50%, -50%) rotate(22.5deg); }
  .r45  { transform: translate(-50%, -50%) rotate(45deg); }
  .r67  { transform: translate(-50%, -50%) rotate(67.5deg); }
  .r90  { transform: translate(-50%, -50%) rotate(90deg); }
  .r112 { transform: translate(-50%, -50%) rotate(112.5deg); }
  .r135 { transform: translate(-50%, -50%) rotate(135deg); }
  .r157 { transform: translate(-50%, -50%) rotate(157.5deg); }
  .cap {
    position: absolute;
    left: 50%;
    top: 50%;
    ...
    border-radius: 999px;
    transform: translate(-50%, -50%);
    box-shadow: 0 0 10px rgba(71,195,248,0.55);
  }
...
<body>
  <div class="wrap">
    <div class="snow">
      <div class="pulse">
        <span class="bar r0"></span>
        <span class="bar r22"></span>
        <span class="bar r45"></span>
        <span class="bar r67"></span>
        <span class="bar r90"></span>
        <span class="bar r112"></span>
        <span class="bar r135"></span>
        <span class="bar r157"></span>

        <span class="cap c0"></span>
        <span class="cap c22"></span>
        <span class="cap c45"></span>
        <span class="cap c67"></span>
        <span class="cap c90"></span>
        <span class="cap c112"></span>
        <span class="cap c135"></span>
        <span class="cap c157"></span>
      </div>
    </div>
  </div>
</body>
